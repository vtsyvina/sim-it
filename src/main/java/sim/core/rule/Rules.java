...
public class Rules {
    ...
    public static Rule if_(Function<Context, Boolean> expression, BlockRule thenBlock) {
        return new IfRule(expression, thenBlock, new BlockRule(empty()));
    }
    ...
    public static Rule if_(Function<Context, Boolean> expression, Rule thenRule) {
        return new IfRule(expression, new BlockRule(thenRule), new BlockRule(empty()));
    }
